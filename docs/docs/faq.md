...
**Q: What’s the warranty/return policy?**
<br>
Refer to our [Terms and Policies](https://opensprinkler.com/terms-and-conditions/)
...
**Q: Can I use it without a router?**
<br>
Yes. Current firmware supports full operation in **AP** mode, serving as its own WiFi hotspot.
